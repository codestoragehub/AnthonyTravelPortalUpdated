...
{
    public class AnthonyTravelPortalDbContext 
        : IdentityDbContext<ApplicationUser, ApplicationRole, string>, IAnthonyTravelPortalDbContext
    {
        private readonly ICurrentUserService _authenticatedUser;

        private readonly IDateTimeService _dateTime;

        public AnthonyTravelPortalDbContext(DbContextOptions<AnthonyTravelPortalDbContext> options) : base(options)
        {
        ...
        internal static AnthonyTravelPortalDbContext CreateContext()
        {
            ...
            return new AnthonyTravelPortalDbContext(
                new DbContextOptionsBuilder<AnthonyTravelPortalDbContext>()
        ...
        //    builder.ApplyConfigurationsFromAssembly(typeof(AnthonyTravelPortalDbContext).Assembly);
